...
public class AlbumApiController {
    ...
    @PostMapping("/api/album/editCaption/{albumId}")
    public ResponseEntity<?> editCaption(@PathVariable int albumId,@RequestBody AlbumUploadDto albumUploadDto){
        albumService.캡션수정(albumId,albumUploadDto.getCaption());
        return new ResponseEntity<>(new CMRespDto<>(1, "캡션수정성공", null), HttpStatus.OK);
    }
